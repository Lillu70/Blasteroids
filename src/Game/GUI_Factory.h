...
static void gui_add_rebind_row(Add_Rebind_Row_Common_Data* common_data, 
    u8* button_text, 
...
static void gui_create_controls_menu()
{
...

	{
        ...
        //game.gui_handler.last_element_pos -= v2f(0, 10);
	}
...
static void gui_create_leaderboard_menu()
{
    //TODO: This way of doing this takes fuck ton of memory and is slower than needs be.
